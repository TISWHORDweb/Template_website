...
var HeaderVideo = (function ($, document) {
    ...
    var createFrame = function() {
        ...
        if(videoDetails.provider === 'youtube') {
            var html = '<iframe id="video" src="http://www.youtube.com/embed/'+videoDetails.id+'?rel=0&hd=1&autohide=1&controls=0&modestbranding=1&autoplay=1&enablejsapi=1&origin=*" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
        }
...
/**
PASSWORD STRENGHT REGISTER FORM
**/
